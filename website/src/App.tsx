      ...
      <main id="top">
        ...
        <section className="section faq-section">
          ...
          <div className="faq-grid">
            <details><summary>Does Palisade prove personhood?</summary><p>No. Its supported ceiling is level 1, and that ceiling is set by missing measurement rather than missing mechanism: interactive liveness and device-bound credential verification are implemented and reachable, but the levels they earn are computed and then withheld, because no confirmed-human false-positive and abandonment interval exists per level yet. Issuer credentials and uniqueness have no verifier at all, and no global proof of personhood is claimed.</p></details>
