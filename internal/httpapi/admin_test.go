...
func TestAdminSurfaceIsSeparateAuthenticatedAndAggregateOnly(t *testing.T) {
	...
	if summary.SchemaVersion != "palisade.admin-summary.v2" || summary.Traffic.Decisions != 1 || summary.Traffic.Enforced.Observe != 1 || summary.Traffic.Computed.Challenge != 1 || summary.Analysis != nil || summary.AnalysisStatus.State != "not_configured" {
